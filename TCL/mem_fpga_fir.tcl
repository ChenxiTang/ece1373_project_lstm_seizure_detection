...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net axi_pcie3_0_axi_aresetn [get_bd_pins axi_mm2s_mapper_0/aresetn] [get_bd_pins axi_pcie3_0/axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_mm2s_mapper_0/aclk] [get_bd_pins axi_pcie3_0/axi_aclk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_250M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk1] [get_bd_pins vio_0/clk]
