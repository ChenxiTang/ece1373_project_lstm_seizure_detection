...
CONFIG.NUM_WRITE_OUTSTANDING {1} \
  ...
  set pcie_status_0 [ create_bd_cell -type ip -vlnv user.org:user:pcie_status:1.0 pcie_status_0 ]
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M08_AXI [get_bd_intf_pins axi_interconnect_0/M08_AXI] [get_bd_intf_pins pcie_status_0/S00_AXI]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_smc/aclk2] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk]
  ...
  connect_bd_net -net reset_rtl_1 [get_bd_ports reset_rtl] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins xdma_0/sys_rst_n]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_mm2s_mapper_0/aclk] [get_bd_pins axi_smc/aclk1] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins dummy1_0/ap_clk] [get_bd_pins dummy1_1/ap_clk] [get_bd_pins dummy1_2/ap_clk] [get_bd_pins dummy1_3/ap_clk] [get_bd_pins fir_compiler_0/aclk] [get_bd_pins mv_input_0/ap_clk] [get_bd_pins mv_output_0/ap_clk] [get_bd_pins mv_state_0/ap_clk] [get_bd_pins pcie_status_0/s00_axi_aclk] [get_bd_pins rst_ddr4_0_300M/slowest_sync_clk] [get_bd_pins vio_0/clk] [get_bd_pins xdma_0/axi_aclk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A80000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs pcie_status_0/S00_AXI/S00_AXI_reg] SEG_pcie_status_0_S00_AXI_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A80000 [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs pcie_status_0/S00_AXI/S00_AXI_reg] SEG_pcie_status_0_S00_AXI_reg
