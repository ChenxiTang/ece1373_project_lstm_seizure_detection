...
#
# impl_setting1.tcl: Tcl script for re-creating project 'prj_design1'
#
# Generated by Vivado on Thu Jun 06 20:50:18 UTC 2019
...
#
# 1. This project restoration tcl script (impl_setting1.tcl) that was generated.
#
...
#
#    "/home/tangche/test/vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/design_1.bd"
#    "/home/tangche/test/vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
...
set script_file "impl_setting1.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/../vivado_designs/new"]"

# Create project
create_project prj_design1 ./prj_design1 -part xcvu095-ffvc1517-2-e
...
set obj [get_projects prj_design1]
set_property -name "board_connections" -value "" -objects $obj
set_property -name "board_part" -value "" -objects $obj
set_property -name "compxlib.activehdl_compiled_library_dir" -value "$proj_dir/prj_design1.cache/compile_simlib/activehdl" -objects $obj
set_property -name "compxlib.funcsim" -value "1" -objects $obj
set_property -name "compxlib.ies_compiled_library_dir" -value "$proj_dir/prj_design1.cache/compile_simlib/ies" -objects $obj
set_property -name "compxlib.modelsim_compiled_library_dir" -value "$proj_dir/prj_design1.cache/compile_simlib/modelsim" -objects $obj
set_property -name "compxlib.overwrite_libs" -value "0" -objects $obj
set_property -name "compxlib.questa_compiled_library_dir" -value "$proj_dir/prj_design1.cache/compile_simlib/questa" -objects $obj
set_property -name "compxlib.riviera_compiled_library_dir" -value "$proj_dir/prj_design1.cache/compile_simlib/riviera" -objects $obj
set_property -name "compxlib.timesim" -value "1" -objects $obj
set_property -name "compxlib.vcs_compiled_library_dir" -value "$proj_dir/prj_design1.cache/compile_simlib/vcs" -objects $obj
...
set_property -name "ip_output_repo" -value "$proj_dir/prj_design1.cache/ip" -objects $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../IP_REPO/ocl_ips"] [file normalize "$origin_dir/../hls_proj/ph_proj/solution1/impl/ip"] [file normalize "$origin_dir/../hls_proj/ElemWiseSigmoid_proj/solution1/impl/ip"] [file normalize "$origin_dir/../hls_proj/ElemWiseTanh_proj/solution1/impl/ip"] [file normalize "$origin_dir/../hls_proj/ElemWiseVecAdd_proj/solution1/impl/ip"] [file normalize "$origin_dir/../hls_proj/ElemWiseVecMul_proj/solution1/impl/ip"] [file normalize "$origin_dir/../hls_proj/mv_input_proj/solution1/impl/ip"] [file normalize "$origin_dir/../hls_proj/mv_output_proj/solution1/impl/ip"] [file normalize "$origin_dir/../hls_proj/mv_state_proj/solution1/impl/ip"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/../vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/design_1.bd"]"\
 "[file normalize "$origin_dir/../vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]"\
 "[file normalize "$origin_dir/../adm-pcie-8v3_custom_parts_2400.csv"]"\
 "[file normalize "$origin_dir/../FIR_coe/FIR_0.5Hz_4Hz.coe"]"\
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/design_1.bd"
...
set file "$origin_dir/../vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/../adm-pcie-8v3_custom_parts_2400.csv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "$origin_dir/../FIR_coe/FIR_0.5Hz_4Hz.coe"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "[file normalize "$origin_dir/../support/bitstream.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../support/bitstream.xdc"
set file [file normalize $file]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../support/ddr4sdram_b0_lane8.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../support/ddr4sdram_b0_lane8.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../support/ddr4sdram_b0_unused.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../support/ddr4sdram_b0_unused.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../support/ddr4sdram_locs_b0_twin_die.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../support/ddr4sdram_locs_b0_twin_die.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../support/ddr4sdram_locs_b0_x64.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../support/ddr4sdram_locs_b0_x64.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../support/ddr4sdram_locs_b0_x72.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../support/ddr4sdram_locs_b0_x72.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../support/ddr4sdram_props_b0_twin_die.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../support/ddr4sdram_props_b0_twin_die.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../support/pcie_constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/../support/pcie_constr.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
puts "INFO: Project created:prj_design1"
