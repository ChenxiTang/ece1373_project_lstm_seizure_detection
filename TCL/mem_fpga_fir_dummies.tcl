...
CONFIG.NUM_WRITE_OUTSTANDING {1} \
  ...
  # Create instance: dummy1_4, and set properties
  set dummy1_4 [ create_bd_cell -type ip -vlnv xilinx.com:hls:dummy1:1.0 dummy1_4 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /dummy1_4/s_axi_ctrl]

  # Create instance: dummy1_5, and set properties
  set dummy1_5 [ create_bd_cell -type ip -vlnv xilinx.com:hls:dummy1:1.0 dummy1_5 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /dummy1_5/s_axi_ctrl]
...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins dummy1_5/s_axi_ctrl]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins dummy1_0/s_axi_ctrl]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_interconnect_0/M06_AXI] [get_bd_intf_pins dummy1_4/s_axi_ctrl]
  ...
  connect_bd_intf_net -intf_net dummy1_0_m_axi_gmem [get_bd_intf_pins dummy1_0/m_axi_gmem] [get_bd_intf_pins smartconnect_0/S06_AXI]
  ...
  connect_bd_intf_net -intf_net dummy1_4_m_axi_gmem [get_bd_intf_pins dummy1_4/m_axi_gmem] [get_bd_intf_pins smartconnect_0/S10_AXI]
  connect_bd_intf_net -intf_net dummy1_5_m_axi_gmem [get_bd_intf_pins dummy1_5/m_axi_gmem] [get_bd_intf_pins smartconnect_0/S05_AXI]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x80000000 [get_bd_addr_spaces dummy1_4/Data_m_axi_gmem] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_ddr4_0_C0_DDR4_ADDRESS_BLOCK
  create_bd_addr_seg -range 0x80000000 -offset 0x80000000 [get_bd_addr_spaces dummy1_5/Data_m_axi_gmem] [get_bd_addr_segs ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] SEG_ddr4_0_C0_DDR4_ADDRESS_BLOCK
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x44A50000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs dummy1_4/s_axi_ctrl/Reg] SEG_dummy1_4_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x44A60000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs dummy1_5/s_axi_ctrl/Reg] SEG_dummy1_5_Reg
