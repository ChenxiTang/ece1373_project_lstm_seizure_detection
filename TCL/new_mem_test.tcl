...
CONFIG.CONST_VAL {0} \
  ...
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk_sync_rst [get_bd_pins ddr4_0/c0_ddr4_ui_clk_sync_rst] [get_bd_pins proc_sys_reset_300M/ext_reset_in] [get_bd_pins rst_clk_wiz_0_250M/ext_reset_in] [get_bd_pins util_vector_logic_0/Op1]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_pcie3_0/axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_0_250M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk1] [get_bd_pins vio_0/clk]
  ...
  connect_bd_net -net reset_1 [get_bd_ports reset_rtl] [get_bd_pins util_vector_logic_1/Op1]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins smartconnect_0/aresetn] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins axi_pcie3_0/sys_rst_n] [get_bd_pins util_vector_logic_1/Res]
