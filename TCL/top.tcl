...
source TCL/mem_fpga_fir_mvs_cdma.tcl

##start synthesising and generating bit stream

validate_bd_design

##generate_target all [get_files ./vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/design_1.bd]

open_bd_design {vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/design_1.bd}

make_wrapper -files [get_files ./vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/design_1.bd] -top

add_files -norecurse ./vivado_designs/new/prj_design1.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
